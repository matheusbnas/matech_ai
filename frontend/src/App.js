              ...
              <div className="p-8 md:w-2/3">
                ...
                <form onSubmit={(e) => {
                  ...
                  <div className="mb-6">
                    ...
                    <input type="text" id="subject" name="subject" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                  </div>
